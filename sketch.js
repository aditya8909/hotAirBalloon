...
function draw() {
  ...
  if(keyDown(LEFT_ARROW)){
    ...
    balloon.changeAnimation("abc",balloonImage2)
  }
  else if(keyDown(RIGHT_ARROW)){
    updateHeight(10,0);
    //add the animation of balloon [use balloonImage2]
    balloon.changeAnimation("ab4c",balloonImage2)
 ...
 //add the animation of balloon [use balloonImage2]
    ...
    balloon.changeAnimation("abfc",balloonImage2)
  ...
  //add the animation of balloon [use balloonImage2]
    balloon.scale=balloon.scale+0.005;
    balloon.changeAnimation("abtc",balloonImage2)
